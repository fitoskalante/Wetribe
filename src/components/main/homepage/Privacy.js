...
export default function Profile(props) {
  return (
    <>
      <div className="container-fluid bg-light m-0  py-5">
        <div className="container bg-white shadow  rounded-custom h-100  d-flex flex-column justify-content-center align-items-center p-5">
          <h1>Privacy Policy</h1>

          <p>Effective date: December 16, 2019</p>

          <p>
            Weetribe ("us", "we", or "our") operates the
            https://friendly-dubinsky-e43212.netlify.com/ website (the
            "Service").
          </p>
          ...
          <p>
            ...
            Weetribe is created with the help of the{" "}
          ...
          <p>
            ...
            https://friendly-dubinsky-e43212.netlify.com/
          </p>
          ...
          <p>Weetribe uses the collected data for various purposes:</p>
          <ul>
          ...
          <p>
            If you are located outside Viet Nam and choose to provide
            information to us, please note that we transfer the data, including
            Personal Data, to Viet Nam and process it there.
          </p>
          <p>
          ...
          <p>
            Weetribe will take all steps reasonably necessary to ensure that
          ...
          <p>
            Weetribe may disclose your Personal Data in the good faith belief
            that such action is necessary to:
          </p>
          <ul>
            <li>To comply with a legal obligation</li>
            <li>To protect and defend the rights or property of Weetribe</li>
            <li>
          ...
          <ul>
            <li>By email: fitoskalante@gmail.com</li>
          </ul>
        </div>
      </div>
      )}
